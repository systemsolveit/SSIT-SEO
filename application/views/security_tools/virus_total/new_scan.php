...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('antivirus/virus_total') ?>"><?php echo $this->lang->line("VirusTotal Scan");?></a></div>
...
<div class="row multi_layout">
    ...
    <div class="card main_card">
      ...
      <form  method="POST" enctype="multipart/form-data"  id="new_search_form">
        ...
        <div class="card-footer bg-whitesmoke mt-240">
            ...
            <button class="btn btn-secondary btn-md float-right" onclick="goBack('antivirus/virus_total')" type="button"><i class="fa fa-remove"></i> <?php echo $this->lang->line('Cancel'); ?></button>
  ...
  <div class="col-12 col-md-8 col-lg-8 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-shield-alt"></i> <?php echo $this->lang->line('VirusTotal Scan Results'); ?></h4>
  ...
  $("document").ready(function(){
    ...
    $(document).on('click', '#new_search_button', function(event) {
      event.preventDefault();
        ...
        $.ajax({
          url:base_url+'antivirus/virus_total_scan_action',
          type:'POST',
