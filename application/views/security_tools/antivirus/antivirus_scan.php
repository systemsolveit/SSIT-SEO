...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary" href="<?php echo base_url("antivirus/malware");?>">
            ...
            <div class="table-responsive2">
                ...
                <thead>
                	<tr>
        						...
        						<th><?php echo $this->lang->line("Google Status"); ?></th>
        						<th><?php echo $this->lang->line("Norton Status"); ?></th>
        						<th><?php echo $this->lang->line("Mcafee Status"); ?></th>
...
$(document).ready(function($) {
  ...
  var table = $("#mytable").DataTable({
      ...
      ajax: 
      {
        "url": base_url+'antivirus/scan_data',
        "type": 'POST',
  	    data: function ( d )
  	    {
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          context: this,
          type:'POST' ,
          url:"<?php echo base_url('antivirus/scan_delete')?>",
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your malware scan item has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          ...
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your all malware total item has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
