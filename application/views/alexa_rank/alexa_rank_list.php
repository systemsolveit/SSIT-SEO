...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary" href="<?php echo base_url("rank/rank_alexa");?>">
          ...
          <div class="card-body data-card">
            ...
            <div class="table-responsive2">
                ...
                <thead>
                    ...
                    <th><?php echo $this->lang->line("Reach Rank"); ?></th>
                    <th><?php echo $this->lang->line("Top Country"); ?></th>
                    <th><?php echo $this->lang->line("Top Country Rank"); ?></th>
                    <th><?php echo $this->lang->line("Traffic Rank"); ?></th>
...
$(document).ready(function($) {
  ...
  var table = $("#mytable").DataTable({
      ...
      ajax: 
      {
        "url": base_url+'rank/alexa_rank_data',
        "type": 'POST',
  	    data: function ( d )
  	    {
 ...
 $(document).on('click','#download_btn',function(event){
    ...
    $("#alexa_rank_download_selected").addClass('modal-progress');
	 	...
	 	$.ajax({
	 		...
	 		success:function(response)
	 		{
	 			if (response !="") {
	 				...
	 				$("#alexa_rank_download_selected").modal();
	 				$("#total_download_selected").html(response);
          $("#custom_spinner").html("");
          $("#alexa_rank_download_selected").removeClass('modal-progress');
	 			}
	 			else {
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          context: this,
          type:'POST' ,
          url:"<?php echo base_url('rank/alexa_rank_delete')?>",
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your Alexa Rank data has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          ...
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your all alexa rank data has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
...
<div class="modal fade show" id="alexa_rank_download_selected">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background: #fefefe;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-trophy"></i> <?php echo $this->lang->line('Alexa Rank'); ?></h5>
