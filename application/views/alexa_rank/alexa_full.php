...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('rank/alexa_rank_full') ?>"><?php echo $this->lang->line("Alexa Data Analysis");?></a></div>
...
<div class="row multi_layout">
  ...
  <div class="col-12 col-md-7 col-lg-7 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-trophy"></i> <?php echo $this->lang->line('Alexa Data'); ?></h4>
    ...
    $(document).on('click', '#new_search_button', function(event) {
     ...
     var files_list = [];
      $("#file_upload_url").uploadFile({
        url:base_url+"rank/read_text_csv_file_backlink",
        fileName:"myfile",
        ...
        deleteCallback: function (data, pd) {
            var delete_url="<?php echo site_url('rank/read_after_delete_csv_txt');?>";
