...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary" href="<?php echo base_url("rank/alexa_data");?>">
          ...
          <div class="card-body data-card">
            ...
            <div class="table-responsive2">
                ...
                <thead>
                    ...
                    <th><?php echo $this->lang->line("Bounce Rate"); ?></th>
                    <th><?php echo $this->lang->line("Alexa Rank Spend Time"); ?></th>
                    <th><?php echo $this->lang->line("Site Search Traffic"); ?></th>
...
$(document).ready(function($) {
  ...
  var table = $("#mytable").DataTable({
      ...
      ajax: 
      {
        "url": base_url+'rank/alexa_rank_full_data',
        "type": 'POST',
  	    data: function ( d )
  	    {
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          context: this,
          type:'POST' ,
          url:"<?php echo base_url('rank/alexa_rank_full_delete')?>",
          data:{ids:ids},
          success:function(response){ 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background: #fefefe;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-trophy"></i> <?php echo $this->lang->line('Alexa Data'); ?></h5>
