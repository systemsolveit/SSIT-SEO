...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('rank/moz_rank') ?>"><?php echo $this->lang->line("Moz Rank Analysis");?></a></div>
...
<div class="row multi_layout">
  ...
  <div class="col-12 col-md-7 col-lg-7 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-trophy"></i> <?php echo $this->lang->line('Moz Rank'); ?></h4>
