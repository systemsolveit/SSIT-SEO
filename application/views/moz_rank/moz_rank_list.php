...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary" href="<?php echo base_url("rank/moz_rank_analysis");?>">
          ...
          <div class="card-body data-card">
            ...
            <div class="table-responsive2">
                ...
                <thead>
                    ...
                    <th><?php echo $this->lang->line("Subdomain Normalized"); ?></th>         
                    <th><?php echo $this->lang->line("Subdomain Raw"); ?></th>
                    <th><?php echo $this->lang->line("URL Normalized"); ?></th>
                    <th><?php echo $this->lang->line("URL Raw"); ?></th>
                    <th><?php echo $this->lang->line("HTTP Status Code"); ?></th>
                    <th><?php echo $this->lang->line("Domain Authority"); ?></th>
                    <th><?php echo $this->lang->line("Page Authority"); ?></th>
                    <th><?php echo $this->lang->line("External Equity Links"); ?></th>
                    <th><?php echo $this->lang->line("Links"); ?></th>
...
$(document).ready(function($) {
  ...
  var table = $("#mytable").DataTable({
      ...
      ajax: 
      {
        "url": base_url+'rank/moz_rank_data',
        "type": 'POST',
  	    data: function ( d )
  	    {
 ...
 $(document).on('click','#download_btn',function(event){
    ...
    $("#moz_rank_download_selected").addClass('modal-progress');
	 	...
	 	$.ajax({
	 		...
	 		success:function(response)
	 		{
	 			if (response !="") {
	 				...
	 				$("#moz_rank_download_selected").modal();
	 				$("#total_download_selected").html(response);
          $("#custom_spinner").html("");
          $("#moz_rank_download_selected").removeClass('modal-progress');
	 			}
	 			else {
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          context: this,
          type:'POST' ,
          url:"<?php echo base_url('rank/moz_rank_delete')?>",
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your Moz Rank data has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          ...
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your All Moz rank data has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
...
<div class="modal fade show" id="moz_rank_download_selected">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background: #fefefe;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-trophy"></i> <?php echo $this->lang->line('Moz Rank'); ?></h5>
