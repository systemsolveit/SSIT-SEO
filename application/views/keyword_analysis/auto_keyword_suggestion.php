...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('keyword/keyword_suggestion') ?>"><?php echo $this->lang->line("Keyword Auto Suggestion");?></a></div>
...
<div class="row multi_layout">
    ...
    <div class="card main_card">
      ...
      <form  method="POST" enctype="multipart/form-data"  id="new_search_form">
            ...
            <div class="form-group">
              <div class="selectgroup selectgroup-pills">
                ...
                <label class="selectgroup-item" for="keyword_wiki">
                  ...
                  <span class="selectgroup-button"><?php echo $this->lang->line('Wiki'); ?></span>
                </label>                
                <label class="selectgroup-item" for="keyword_amazon">
                  ...
                  <span class="selectgroup-button"><?php echo $this->lang->line('Amazon'); ?></span>
                </label>
        ...
        <div class="card-footer bg-whitesmoke" style="margin-top: 122px!important;">
            ...
            <button class="btn btn-secondary btn-md float-right" onclick="goBack('keyword/auto_keyword')" type="button"><i class="fa fa-remove"></i> <?php echo $this->lang->line('Cancel'); ?></button>
  ...
  <div class="col-12 col-md-8 col-lg-8 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-tags"></i> <?php echo $this->lang->line('Keyword Auto Suggestion'); ?></h4>
