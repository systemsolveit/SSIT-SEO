...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('ip/site_this_ip') ?>"><?php echo $this->lang->line("Sites in same IP");?></a></div>
...
<div class="row multi_layout">
      ...
      <form  method="POST" enctype="multipart/form-data"  id="new_search_form">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="form-label"> <?php echo $this->lang->line("IP Address"); ?><a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("Domain") ?>" data-content='<?php echo $this->lang->line("Put your IP here") ?>'><i class='fa fa-info-circle'></i> </a></label>
  ...
  <div class="col-12 col-md-8 col-lg-8 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-map-marker-alt"></i> <?php echo $this->lang->line('Sites in same ip'); ?></h4>
  ...
  $("document").ready(function(){
    ...
    $(document).on('click', '#new_search_button', function(event) {
     ...
     var domain_name=$("#domain_name").val();
      ...
      if (domain_name == '') {
        swal("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please Enter IP'); ?>", 'error');
        return false;
      }
