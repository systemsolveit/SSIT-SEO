...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('ip/domain_info') ?>"><?php echo $this->lang->line("Domain IP Information");?></a></div>
...
<div class="row multi_layout">
    ...
    <div class="card main_card">
      ...
      <form  method="POST" enctype="multipart/form-data"  id="new_search_form">
        ...
        <div class="card-footer bg-whitesmoke mt-66">
            ...
            <button class="btn btn-secondary btn-md float-right" onclick="goBack('ip/analysis_new')" type="button"><i class="fa fa-remove"></i> <?php echo $this->lang->line('Cancel'); ?></button>
  ...
  <div class="col-12 col-md-7 col-lg-7 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-map-marker-alt"></i> <?php echo $this->lang->line('Domain IP Information'); ?></h4>
