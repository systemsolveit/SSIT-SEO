...
/*  .multi_layout .list-group .list-group-item{border-radius: 0;border:.5px solid #dee2e6;border-left:none;border-right:none;z-index: 0;}
  ...
  .mt-66{margin-top: 47px!important;}
    .ajax-file-upload{
      bottom: 12px;
  }
</style>
...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('ip/ipv6_check') ?>"><?php echo $this->lang->line("IPv6 Compability");?></a></div>
...
<div class="row multi_layout">
      ...
      <form  method="POST" enctype="multipart/form-data"  id="new_search_form">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
              <label class="form-label"> <?php echo $this->lang->line("Domain"); ?> <code>*</code> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="" data-content="Put your domain names comma / new line separated" data-original-title="Domain"><i class="fa fa-info-circle"></i> </a></label>
        ...
        <div class="card-footer bg-whitesmoke mt-66">
            ...
            <button class="btn btn-secondary btn-md float-right" onclick="goBack('ip/sites_same_ip')" type="button"><i class="fa fa-remove"></i> <?php echo $this->lang->line('Cancel'); ?></button>
  ...
  <div class="col-12 col-md-7 col-lg-7 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-map-marker-alt"></i> <?php echo $this->lang->line('IPv6 Compability Check'); ?></h4>
    ...
    $(document).on('click', '#new_search_button', function(event) {
     ...
     var files_list = [];
      $("#file_upload_url").uploadFile({
        url:base_url+"ip/read_text_csv_file_backlink",
        fileName:"myfile",
        ...
        deleteCallback: function (data, pd) {
            var delete_url="<?php echo site_url('ip/read_after_delete_csv_txt');?>";
