...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-table"></i> <?php echo $this->lang->line("alexa data");?></h1>
</section>
				...
				>
					...
					<thead> 	
						<tr>
							...
							<th field="alexa_rank" sortable="true">Alexa Rank</th>
							<th field="bounce_rate" sortable="true">Bounce Rate</th>
							<th field="alexa_rank_spend_time" sortable="true">Alexa Rank Spend Time</th>
							<th field="total_keyword_opportunities_breakdown" sortable="true">Keyword Oppurtunities</th>
				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					...
					<div class="row">						
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<label style="color: <?php echo $THEMECOLORCODE; ?>">
								<i class="fa fa-globe"></i> <?php echo $this->lang->line("enter domain name");?><br/>
							</label>
...
<script>
	...
	{   	   
	    ...
	    return "<a title='<?php echo $this->lang->line("more info"); ?>' href='"+link+"' class='btn btn-outline-primary'><i class='fa fa-table'></i></a>";         
	} 
