...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-table"></i>  <?php echo $this->lang->line("similarweb data");?></h1>
</section>
				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					...
					<div class="row">						
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<label style="color: <?php echo $THEMECOLORCODE; ?>"> <i class="fa fa-globe"></i> <?php echo $this->lang->line("enter domain name");?><br/></label>
...
<script>
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			if(urls=='')
			{
				alertify.alert("<?php echo $this->lang->line('Alert'); ?>","<?php echo $this->lang->line('you have not enter any domain name') ?>");
				return false;
			}
