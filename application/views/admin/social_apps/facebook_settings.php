        ...
        <div class="col-12 col-md-6 col-lg-6">
            <div class="card">
              <div class="card-body">
                  ...
                  <b><?php echo $this->lang->line("Terms of Service URL")." :</b> <span class='blue'>".base_url('home/terms_use');?></span><br/>
              </div>
            </div>
        </div>
        <div class="col-12 col-md-6 col-lg-6">
            <div class="card">
              ...
              <div class="card-body" style="min-height: 145px;">
                  ...
                  <b><?php echo $this->lang->line("Valid OAuth Redirect URI")." </b>: <br><br><span class='blue'>".base_url("home/fb_login_back"); ?></span><br>
	        ...
	        <div class="card">
	          ...
	          <div class="card-body">              
	              <div class="form-group">
	                  ...
	                  <input name="app_name" value="<?php echo isset($app_data['app_name']) ? $app_data['app_name'] : set_value('app_name'); ?>"  class="form-control" type="text">              
	              ...
	              <div class="row">
		                <div class="col-12 col-md-6">
		                  <div class="form-group">
		                    ...
		                    <input name="api_id" value="<?php echo isset($app_data['app_id']) ? $app_data['app_id'] : set_value('api_id'); ?>" class="form-control" type="text">  
		                ...
		                <div class="col-12 col-md-6">
		                  <div class="form-group">
		                    ...
		                    <input name="api_secret" value="<?php echo isset($app_data['app_secret']) ? $app_data['app_secret'] : set_value('api_secret'); ?>" class="form-control" type="text">  
