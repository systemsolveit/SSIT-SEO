						...
						<div class="card-body">
							<div class="row">
	        		            ...
	        		            <div class="col-12 col-md-6">
	        			            <div class="form-group">
	        		           		  <?php	
	        	               			$front_end_search_display = $this->config->item('front_end_search_display');
	        	               			if($front_end_search_display == '') $front_end_search_display='0';
	        	               		  ?>
	        	               		  <br>
	        		           		  <label class="custom-switch mt-2">
	        		           		    <input type="checkbox" name="front_end_search_display" value="1" class="custom-switch-input"  <?php if($front_end_search_display=='1') echo 'checked'; ?>>
	        		           		    <span class="custom-switch-indicator"></span>
	        		           		    <span class="custom-switch-description"><?php echo $this->lang->line('Display Front-end website analysis search');?></span>
	        		           		    <span class="red"><?php echo form_error('front_end_search_display'); ?></span>
	        		           		  </label>
	        		           		</div>
	        	           		</div>
				       		</div>
