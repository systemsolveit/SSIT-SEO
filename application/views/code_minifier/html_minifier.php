...
<section class="section">
  <div class="section-header">
    <h1><i class="fab fa-html5"></i> <?php echo $page_title;?></h1>
...
<div class="row multi_layout">
      ...
      <form enctype="multipart/form-data" method="POST"  id="new_search_form">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="form-label"> <?php echo $this->lang->line("HTML Code Minifier"); ?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("HTML Code Minifier") ?>" data-content='<?php echo $this->lang->line("Write your html code here... ") ?>'><i class='fa fa-info-circle'></i> </a></label>
            <textarea id="html_code" name="html_code" class="form-control" style="width:100%;min-height: 140px;" rows="10"  autofocus></textarea>
          </div>

          <div class="form-group">
                <label> <?php echo $this->lang->line('Files');?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("Files") ?>" data-content='<?php echo $this->lang->line("To minify your single or multiple html files, please select your files by clicking the upload button bellow. ") ?>'><i class='fa fa-info-circle'></i> </a></label>
        ...
        <div class="card-footer bg-whitesmoke mt-66">
            ...
            <button type="button"  id="minify_html" class="btn btn-primary "> <?php echo $this->lang->line("Minify"); ?></button>
  ...
  <div class="col-12 col-md-6 col-lg-6 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fab fa-html5"></i> <?php echo $this->lang->line('HTML Minifier Results'); ?></h4>
...
<script type="text/javascript">
  ...
  $("document").ready(function(){
    ...
    $(document).on('click', '#minify_html', function(event) {
      event.preventDefault();

        var html_code=$("#html_code").val().trim();
        
        if(html_code==''){
          swal("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please write html first'); ?>", 'error');
          return false;
        }

        $('#middle_column_content').html("");
        $("#minify_html").addClass('btn-progress');
        ...
        $.ajax({
          ...
          success:function(response){ 
              $("#minify_html").removeClass('btn-progress');
              $("#custom_spinner").html("");
     ...
     var files_list = [];
      $("#file_upload_url").uploadFile({
        url:base_url+"code_minifier/read_text_file_html",
        fileName:"myfile",
        ...
        deleteCallback: function (data, pd) {
            var delete_url="<?php echo site_url('code_minifier/read_after_delete_html');?>";
