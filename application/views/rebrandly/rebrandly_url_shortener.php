...
<div class="row multi_layout">
      ...
      <form  method="POST" enctype="multipart/form-data"  id="new_search_form">
        ...
        <div class="card-body">
            <div class="form-group">
              <label class="form-label"> <?php echo $this->lang->line("Long URL"); ?> <code>*</code> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("Long URL") ?>" data-content='<?php echo $this->lang->line("The destination URL you want your branded short link to point to") ?>'><i class='fa fa-info-circle'></i> </a></label>
              <input id="long_url" name="long_url" class="form-control" />
            </div>
        

           <div class="form-group">
            <label class="form-label"> <?php echo $this->lang->line("title"); ?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("title") ?>" data-content='<?php echo $this->lang->line("A title you assign to the branded short link in order to remember what's behind it") ?>'><i class='fa fa-info-circle'></i> </a></label>
        ...
        <div class="card-footer bg-whitesmoke mt-140">
            ...
            <button type="button"  id="new_search_button" class="btn btn-primary "><?php echo $this->lang->line("Shortener"); ?></button>
            <button class="btn btn-secondary btn-md float-right" onclick="goBack('url_shortener/rebrandly_shortener')" type="button"><i class="fa fa-remove"></i> <?php echo $this->lang->line('Cancel'); ?></button>
  ...
  <div class="col-12 col-md-8 col-lg-8 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-cut"></i> <?php echo $this->lang->line('Rabrandly URL Shortener'); ?></h4>
...
<script type="text/javascript">
  ...
  $("document").ready(function(){
    ...
    $(document).on('click', '#new_search_button', function(event) {
      ...
      if (long_url == '') {
        swal("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please enter long url'); ?>", 'error');
        return false;
      }
      ...
      $.ajax({
        url:base_url+'url_shortener/rebrandly_shortener_action',
        type:'POST',
