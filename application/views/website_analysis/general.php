		...
		<div class="col-12 col-md-6">
			...
			<div class="list-group">
				...
				<a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action pointer">
					...
					<?php $domain_info[0]['moz_url_normalized'] = isset($domain_info[0]['moz_url_normalized']) ? round((int)$domain_info[0]['moz_url_normalized']) : 0; ?>
					<span class="badge badge-primary badge-pill"><?php echo round((int)$domain_info[0]['moz_url_normalized'])."/10"; ?></span>
				</a>
			</div>
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$estimated_latency[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/estimated-input-latency">'.$this->lang->line("Learn More").'</a></b></p>';
                                                              }
                                                    ...
                                                    <div class="ticket-item">
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              $offscreen_des = explode('[',$lighthouseresult_audits['offscreen-images']['description']);

                                                              echo '<p style="font-size: 12px;line-height: initial;">'.$offscreen_des[0].'<b><a class="text-danger" target="_BLANK" href="https://web.dev/offscreen-images">'.$this->lang->line("Learn More").'</a></b></p>';
                                                              }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                $network_server_lat = explode('[',$lighthouseresult_audits['network-server-latency']['description']);

                                                                    
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$network_server_lat[0]}<b><a class='text-danger' target='_BLANK' href='https://hpbn.co/primer-on-web-performance/#analyzing-the-resource-waterfall'>{$this->lang->line('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                $uses_web_images = explode('[',$lighthouseresult_audits['uses-webp-images']['description']);

                                                                    
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$uses_web_images[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/uses-webp-images'>{$this->lang->line('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                $redirects_des = explode('[',$lighthouseresult_audits['redirects']['description']);

                                                                    
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$redirects_des[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/redirects'>{$this->lang->line('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                $unminified_js = explode('[',$lighthouseresult_audits['unminified-javascript']['description']);

                                                                    
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$unminified_js[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/unminified-javascript'>{$this->lang->line('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                $user_times = explode('[',$lighthouseresult_audits['user-timings']['description']);

                                                                    
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$user_times[0]}<b><a class='text-danger' target='_BLANK' href='https://web.dev/user-timings'>{$this->lang->line('Learn More')}</a></b></p>";
                                                                }
                                                        ...
                                                        <div class="ticket-title" style="color:#6777ef;">
                                                            <h4>
                                                              ...
                                                              data-description="<?php
                                                                ...
                                                                $network_rtt = explode('[',$lighthouseresult_audits['network-rtt']['description']);

                                                                    
                                                                echo "<p style='font-size: 12px;line-height: initial;'>{$network_rtt[0]}<b><a class='text-danger' target='_BLANK' href='https://hpbn.co/primer-on-latency-and-bandwidth/'>{$this->lang->line('Learn More')}</a></b></p>";
                                                                }
		...
		<div class="col-12 col-md-6">
			...
			<ul class="list-group ip-info">
				...
				<li class="list-group-item"><b><i class="fas fa-asterisk text-primary"></i>&nbsp; <?php echo $this->lang->line('Country'); ?> : </b>
					<?php 
						$ipinfo_country = isset($domain_info[0]['ipinfo_country']) ? $domain_info[0]['ipinfo_country'] : '';
						$x = trim(strtoupper($ipinfo_country));
					?>
			...
			<div class="card card-hero custom_card-hero">
				...
				<div class="card-body p-0">
					<div class="tickets-list">
						<div class="row">
							<?php 
								if(isset($domain_info[0]["sites_in_same_ip"]) && $domain_info[0]["sites_in_same_ip"]!='')
				...
				<div class="card-body p-0">
					<div class="tickets-list">
						<div class="tickets-list">
							<div class="row">
								<?php 
									if(isset($domain_info[0]['similar_sites']) && $domain_info[0]['similar_sites']!= '')
