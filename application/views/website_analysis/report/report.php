		...
		<div class="col-md-6" style="float: left;">
			<ul class="list-group pdf-list-group">
				...
				<li class="list-group-item"><b><?php echo $this->lang->line('Country'); ?> : </b>
					<?php $x = isset($domain_info[0]['ipinfo_country']) ? trim(strtoupper($domain_info[0]['ipinfo_country'])) : '';?>
	...
	<div class="row">
		<div class="col-md-6" style="float: left;">
			<ul class="list-group pdf-list-group">
				...
				<?php 
					$sites_in_same_ip = isset($domain_info[0]["sites_in_same_ip"]) ? json_decode($domain_info[0]["sites_in_same_ip"],true) : '';
					...
					if(is_array($sites_in_same_ip) && count($sites_in_same_ip)==0) echo '<li class="list-group-item">'.$this->lang->line("No data to show").'</li>';
				?>
		...
		<div class="col-md-6" style="float: right;">
			<ul class="list-group pdf-list-group">
				...
				<?php 
					$similar_sites = explode(',', isset($domain_info[0]['similar_site']) ? $domain_info[0]['similar_site'] : '');
					$i=1;
...
<!-- *************************************meta tag info *********************************************** -->
<?php
	$h1 = isset($domain_info[0]['h1']) ? json_decode($domain_info[0]['h1'],true) : '';
	$h2 = isset($domain_info[0]['h2']) ? json_decode($domain_info[0]['h2'],true) : '';
	$h3 = isset($domain_info[0]['h3']) ? json_decode($domain_info[0]['h3'],true) : '';
	$h4 = isset($domain_info[0]['h4']) ? json_decode($domain_info[0]['h4'],true) : '';
	$h5 = isset($domain_info[0]['h5']) ? json_decode($domain_info[0]['h5'],true) : '';
	$h6 = isset($domain_info[0]['h6']) ? json_decode($domain_info[0]['h6'],true) : '';
	$meta_tag_information = isset($domain_info[0]['meta_tag_information']) ? json_decode($domain_info[0]['meta_tag_information'],true) : '';
	...
	$one_phrase = isset($domain_info[0]['one_phrase']) ? json_decode($domain_info[0]['one_phrase'],true) : '';
	$two_phrase = isset($domain_info[0]['two_phrase']) ? json_decode($domain_info[0]['two_phrase'],true) : '';
	$three_phrase = isset($domain_info[0]['three_phrase']) ? json_decode($domain_info[0]['three_phrase'],true) : '';
	$four_phrase = isset($domain_info[0]['four_phrase']) ? json_decode($domain_info[0]['four_phrase'],true) : '';
	...
	<div class="col-12">
		<ul class="list-group pdf-list-group">
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					<li style="font-weight:bold;color:#191919;border: solid 1px #E1E1E1;padding: 10px;background-color:#E1E1E1;list-style:none !important">
						H1(<?php echo is_array($h1) ? count($h1) : 0 ?>)
					</li>
					<?php $h1_no = 1; ?>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					<li style="font-weight:bold;color:#191919;border: solid 1px #E1E1E1;padding: 10px;background-color:#E1E1E1;list-style:none !important">
						H2(<?php echo is_array($h2) ? count($h2) : 0 ?>)
					</li>
					<?php $h2_no = 1; ?>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					<li style="font-weight:bold;color:#191919;border: solid 1px #E1E1E1;padding: 10px;background-color:#E1E1E1;list-style:none !important">
						H3(<?php echo is_array($h3) ? count($h3) : 0 ?>)
					</li>
					<?php $h3_no = 1; ?>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					<li style="font-weight:bold;color:#191919;border: solid 1px #E1E1E1;padding: 10px;background-color:#E1E1E1;list-style:none !important">
						H4(<?php echo is_array($h4) ? count($h4) : 0 ?>)
					</li>
					<?php $h4_no = 1; ?>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					<li style="font-weight:bold;color:#191919;border: solid 1px #E1E1E1;padding: 10px;background-color:#E1E1E1;list-style:none !important">
						H5(<?php echo is_array($h5) ? count($h5) : 0 ?>)
					</li>
					<?php $h5_no = 1; ?>
			...
			<li class="list-group-item" style="border:none !important;">
				<ul class="list-group pdf-list-group" style="padding: 0 30px !important">
					<li style="font-weight:bold;color:#191919;border: solid 1px #E1E1E1;padding: 10px;background-color:#E1E1E1;list-style:none !important">
						H6(<?php echo is_array($h6) ? count($h6) : 0 ?>)
					</li>
					<?php $h6_no = 1; ?>
...
<?php 
	...
	$card_geography_country = isset($alexa_data_full["card_geography_country"]) ? json_decode($alexa_data_full["card_geography_country"],true) : '';
