<?php
	$h1 = isset($meta_tag_info[0]['h1']) ? json_decode($meta_tag_info[0]['h1']) : [];
	$h2 = isset($meta_tag_info[0]['h2']) ? json_decode($meta_tag_info[0]['h2']) : [];
	$h3 = isset($meta_tag_info[0]['h3']) ? json_decode($meta_tag_info[0]['h3']) : [];
	$h4 = isset($meta_tag_info[0]['h4']) ? json_decode($meta_tag_info[0]['h4']) : [];
	$h5 = isset($meta_tag_info[0]['h5']) ? json_decode($meta_tag_info[0]['h5']) : [];
	$h6 = isset($meta_tag_info[0]['h6']) ? json_decode($meta_tag_info[0]['h6']) : [];
	$meta_tag_information = isset($meta_tag_info[0]['meta_tag_information']) ? json_decode($meta_tag_info[0]['meta_tag_information'],true) : [];
	...
	$one_phrase = isset($meta_tag_info[0]['one_phrase']) ? json_decode($meta_tag_info[0]['one_phrase'],true) : [];
	$two_phrase = isset($meta_tag_info[0]['two_phrase']) ? json_decode($meta_tag_info[0]['two_phrase'],true) : [];
	$three_phrase = isset($meta_tag_info[0]['three_phrase']) ? json_decode($meta_tag_info[0]['three_phrase'],true) : [];
	$four_phrase = isset($meta_tag_info[0]['four_phrase']) ? json_decode($meta_tag_info[0]['four_phrase'],true) : [];
