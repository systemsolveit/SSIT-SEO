...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary" href="<?php echo base_url("social/analysis_new");?>">
          ...
          <div class="card-body data-card">
            ...
            <div class="table-responsive2">
                ...
                <thead>
                    ...
                    <th><?php echo $this->lang->line("Facebook Share"); ?></th>
                    <th><?php echo $this->lang->line("Facebook Reaction"); ?></th>
                    <th><?php echo $this->lang->line("Facebook Comment"); ?></th>
                    <th><?php echo $this->lang->line("Xing Share"); ?></th>
                    <th><?php echo $this->lang->line("Pinterest Pin"); ?></th>
                    <th><?php echo $this->lang->line("Reddit Score"); ?></th>
                    <th><?php echo $this->lang->line("Reddit UP"); ?></th>
                    <th><?php echo $this->lang->line("Reddit Down"); ?></th>
                    <th><?php echo $this->lang->line("Buffer Share"); ?></th>
...
$(document).ready(function($) {
  ...
  var table = $("#mytable").DataTable({
      ...
      ajax: 
      {
        "url": base_url+'social/social_list_data',
        "type": 'POST',
  	    data: function ( d )
  	    {
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          context: this,
          type:'POST' ,
          url:"<?php echo base_url('social/social_delete')?>",
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your social network analysis data has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          ...
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your all social network analysis data has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
...
<div class="modal fade show" id="social_network_download_selected">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background: #fefefe;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-share-alt"></i> <?php echo $this->lang->line('Social Network Analysis'); ?></h5>
