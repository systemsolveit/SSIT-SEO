...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('url_shortener/index') ?>"><?php echo $this->lang->line("Bitly URL Shortener");?></a></div>
...
<div class="row multi_layout">
      ...
      <form  method="POST" enctype="multipart/form-data"  id="new_search_form">
        ...
        <div class="card-body">
          <div class="form-group">
            <label class="form-label"> <?php echo $this->lang->line("Long URL"); ?> <code>*</code> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("Long URL") ?>" data-content='<?php echo $this->lang->line("Put your long urls or upload text/csv file - comma / new line separated") ?>'><i class='fa fa-info-circle'></i> </a></label>
        ...
        <div class="card-footer bg-whitesmoke mt-42">
            ...
            <button class="btn btn-secondary btn-md float-right" onclick="goBack('url_shortener/index')" type="button"><i class="fa fa-remove"></i> <?php echo $this->lang->line('Cancel'); ?></button>
  ...
  <div class="col-12 col-md-7 col-lg-7 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-cut"></i> <?php echo $this->lang->line('Bitly URL Shortener'); ?></h4>
    ...
    $(document).on('click', '#new_search_button', function(event) {
     ...
     var files_list = [];
      $("#file_upload_url").uploadFile({
        url:base_url+"url_shortener/read_text_csv_file_backlink",
        fileName:"myfile",
        ...
        deleteCallback: function (data, pd) {
            var delete_url="<?php echo site_url('url_shortener/read_after_delete_csv_txt');?>";
