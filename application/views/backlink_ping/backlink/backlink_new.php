...
<section class="section">
  <div class="section-header">
    <h1><i class="fas fa-vector-square"></i> <?php echo $page_title;?></h1>
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('backlink/backlink_search') ?>"><?php echo $this->lang->line("Google Backlink Search");?></a></div>
...
<div class="row multi_layout">
      ...
      <form  method="POST" enctype="multipart/form-data"  id="new_search_form">
        ...
        <div class="card-body">
          <div class="form-group">
            <label class="form-label"> <?php echo $this->lang->line("Google Backlink"); ?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("Google Backlink") ?>" data-content='<?php echo $this->lang->line("Put your domain name ") ?>'><i class='fa fa-info-circle'></i> </a></label>
        ...
        <div class="card-footer bg-whitesmoke mt-66">
            ...
            <button class="btn btn-secondary btn-md float-right" onclick="goBack('backlink/backlink_search')" type="button"><i class="fa fa-remove"></i> <?php echo $this->lang->line('Cancel'); ?></button>
  ...
  <div class="col-12 col-md-6 col-lg-6 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-vector-square"></i> <?php echo $this->lang->line('Google Backlink Search Results'); ?></h4>
  ...
  $("document").ready(function(){
    ...
    $(document).on('click', '#new_search_button', function(event) {
      event.preventDefault();
        ...
        $("#custom_spinner").html('<div class="text-center waiting"><i class="fas fa-spinner fa-spin blue text-center"></i></div><br/><p class="text-center"><?php echo $this->lang->line('Please wait...'); ?></p>');
     ...
     var files_list = [];
      $("#file_upload_url").uploadFile({
        url:base_url+"backlink/read_text_csv_file_backlink",
        fileName:"myfile",
        ...
        deleteCallback: function (data, pd) {
            var delete_url="<?php echo site_url('backlink/read_after_delete_csv_txt');?>";
