...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
     <a class="btn btn-primary" href="<?php echo base_url("backlink/backlink_new");?>">
            ...
            <div class="table-responsive2">
                ...
                <thead>
                	<tr>
        						...
        						<th><?php echo $this->lang->line("Backlink Count"); ?></th>
...
$(document).ready(function($) {
  ...
  var table = $("#mytable").DataTable({
      ...
      ajax: 
      {
        "url": base_url+'backlink/backlink_search_data',
        "type": 'POST',
  	    data: function ( d )
  	    {
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          context: this,
          type:'POST' ,
          url:"<?php echo base_url('backlink/backlink_search_delete')?>",
          data:{ids:ids},
          success:function(response){ 
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          ...
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your all google backlink search total item has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
