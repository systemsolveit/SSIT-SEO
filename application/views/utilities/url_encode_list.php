...
<div class="row multi_layout">
      ...
      <form enctype="multipart/form-data" method="POST"  id="new_search_form">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="form-label"> <?php echo $this->lang->line("URL Encoder/Decoder"); ?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("URL Encoder/Decoder") ?>" data-content='<?php echo $this->lang->line("Put your URLs or upload text/csv file - comma / new line separated") ?>'><i class='fa fa-info-circle'></i> </a></label>
  ...
  <div class="col-12 col-md-7 col-lg-7 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-link"></i> <?php echo $this->lang->line('URL Encoder/Decoder Results'); ?></h4>
