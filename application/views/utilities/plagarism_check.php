...
<div class="row multi_layout">
      ...
      <form enctype="multipart/form-data" method="POST"  id="new_search_form">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="form-label"> <?php echo $this->lang->line("Plagiarism Check"); ?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("Plagiarism Check") ?>" data-content='<?php echo $this->lang->line("put your text or upload text file with contain 500 words(max)") ?>'><i class='fa fa-info-circle'></i> </a></label>
  ...
  <div class="col-12 col-md-6 col-lg-6 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-language"></i> <?php echo $this->lang->line('Plagiarism Check Results'); ?></h4>
  ...
  $("document").ready(function(){
    ...
    $(document).on('click', '#new_search_button', function(event) {
      event.preventDefault();
        ...
        if(emails==''){
          swal("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please enter your contents'); ?>", 'error');
          return false;
        }
        ...
        $.ajax({
          ...
          success:function(response){ 
            ...
            if(response == 2){
              ...
              swal("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Sorry, your bulk limit is exceeded for this module. See your usage log'); ?>", 'error').then(function(){
              ...
              swal("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Sorry, your limit is exceeded for this module. See your usage log'); ?>", 'error').then(function(){
                window.location = base_url+'payment/usage_history';
              });
              return false;
              ...
              if(res[0]=='size_error'){
                ...
                swal("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('You have entered too large string'); ?>", 'error');
                return false;
              }

              if(res[0]=='blank_error'){
                swal("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('you have provided a blank string'); ?>", 'error');
                return false;
              }
            }
