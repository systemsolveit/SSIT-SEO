...
<section class="section">
  <div class="section-header">
    <h1><i class="fab fa-centercode"></i> <?php echo $page_title;?></h1>
...
<div class="row multi_layout">
      ...
      <form enctype="multipart/form-data" method="POST"  id="new_search_form">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="form-label"> <?php echo $this->lang->line("Base64 Encoder/Decoder"); ?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("Base64 Encoder/Decoder") ?>" data-content='<?php echo $this->lang->line("Put your contents here") ?>'><i class='fa fa-info-circle'></i> </a></label>
  ...
  <div class="col-12 col-md-7 col-lg-7 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fab fa-centercode"></i> <?php echo $this->lang->line('Base64 Encoder/Decoder Results'); ?></h4>
  ...
  $("document").ready(function(){
    ...
    $(document).on('click', '#new_search_button', function(event) {
      event.preventDefault();
        ...
        if(base64==''){
          swal("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('You have not enter any content'); ?>", 'error');
          return false;
        }
