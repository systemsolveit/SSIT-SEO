...
<section class="section">
  <div class="section-header">
    <h1><i class="fas fa-envelope-square"></i> <?php echo $page_title;?></h1>
...
<div class="row multi_layout">
      ...
      <form enctype="multipart/form-data" method="POST"  id="new_search_form">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="form-label"> <?php echo $this->lang->line("Duplicate Email Filter"); ?> <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("Duplicate Email Filter") ?>" data-content='<?php echo $this->lang->line("Put your emails or upload text/csv file - comma/in new line separated") ?>'><i class='fa fa-info-circle'></i> </a></label>
  ...
  <div class="col-12 col-md-6 col-lg-6 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-envelope-square"></i> <?php echo $this->lang->line('Duplicate Email Filter Results'); ?></h4>
