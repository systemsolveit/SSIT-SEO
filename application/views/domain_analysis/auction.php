          ...
          <div class="card-body data-card">
            ...
            <div class="table-responsive2">
                ...
                <thead>
                    ...
                    <th><?php echo $this->lang->line("Auction Type"); ?></th>
                    <th><?php echo $this->lang->line("Auction End Date"); ?></th>
                    <th><?php echo $this->lang->line("Sync. At"); ?></th>
...
$(document).ready(function($) {
  ...
  var table = $("#mytable").DataTable({
      ...
      ajax: 
      {
        "url": base_url+'expired_domain/expired_domain_data',
        "type": 'POST',
  	    data: function ( d )
  	    {
 ...
 $(document).on('click','#download_btn',function(event){
    ...
    $("#auction_list_download_selected").addClass('modal-progress');
	 	...
	 	$.ajax({
	 		...
	 		success:function(response)
	 		{
	 			if (response !="") {
	 				...
	 				$("#auction_list_download_selected").modal();
	 				$("#total_download_selected").html(response);
          $("#custom_spinner").html("");
          $("#auction_list_download_selected").removeClass('modal-progress');
	 			}
	 			else {
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background: #fefefe;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-server"></i> <?php echo $this->lang->line('Auction Domain List'); ?></h5>
