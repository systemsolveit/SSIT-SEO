...
<section class="section section_custom">
  <div class="section-header">
    <h1><i class="fas fa-server"></i> <?php echo $page_title; ?></h1>
    <div class="section-header-button">
     <a class="btn btn-primary" href="<?php echo base_url("who_is/who_is");?>">
          ...
          <div class="card-body data-card">
            ...
            <div class="table-responsive2">
                ...
                <thead>
                    ...
                    <th><?php echo $this->lang->line("Admin Name"); ?></th>
                    <th><?php echo $this->lang->line("Admin Email"); ?></th>
                    <th><?php echo $this->lang->line("Admin Country"); ?></th>
                    <th><?php echo $this->lang->line("Admin Phone No."); ?></th>
                    <th><?php echo $this->lang->line("Admin Street"); ?></th>
                    <th><?php echo $this->lang->line("Admin City"); ?></th>
                    <th><?php echo $this->lang->line("Admin Postal Code"); ?></th>
                    <th><?php echo $this->lang->line("Tech Email"); ?></th>
                    <th><?php echo $this->lang->line("Registrant Email"); ?></th>
                    <th><?php echo $this->lang->line("Registrant Name"); ?></th>
                    <th><?php echo $this->lang->line("Registrant Organization"); ?></th>
                    <th><?php echo $this->lang->line("Registrant Street"); ?></th>
                    <th><?php echo $this->lang->line("Registrant City"); ?></th>
                    <th><?php echo $this->lang->line("Registrant State"); ?></th>
                    <th><?php echo $this->lang->line("Registrant Postal Code"); ?></th>
                    <th><?php echo $this->lang->line("Registrant Country"); ?></th>
                    <th><?php echo $this->lang->line("Registrant Phone"); ?></th>
                    <th><?php echo $this->lang->line("Registrant URL"); ?></th>
                    <th><?php echo $this->lang->line("Is Registered"); ?></th>
                    <th><?php echo $this->lang->line("Name Server"); ?></th>
                    <th><?php echo $this->lang->line("Created At"); ?></th>
                    <th><?php echo $this->lang->line("Changed At"); ?></th>
                    <th><?php echo $this->lang->line("Expired At"); ?></th>
...
$(document).ready(function($) {
  ...
  var table = $("#mytable").DataTable({
      ...
      ajax: 
      {
        "url": base_url+'who_is/who_is_list_data',
        "type": 'POST',
  	    data: function ( d )
  	    {
 ...
 $(document).on('click','#download_btn',function(event){
    ...
    $("#who_is_download_selected").addClass('modal-progress');
    $("#custom_spinner").html('<div class="text-center waiting"><i class="fas fa-spinner fa-spin blue text-center"></i></div><br/>');
	 	$.ajax({
          ...
          $("#custom_spinner").html("");
          $("#who_is_download_selected").removeClass('modal-progress');
	 			}
	 			else {
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          context: this,
          type:'POST' ,
          url:"<?php echo base_url('who_is/who_is_delete')?>",
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your Whois data analysis data has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
    ...
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          ...
          data:{ids:ids},
          success:function(response){ 
            iziToast.success({title: '',message: '<?php echo $this->lang->line("Your all Whois analysis data has been deleted successfully."); ?>',position: 'bottomRight'});
            table.draw();
          }
        });
      } 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background: #fefefe;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-server"></i> <?php echo $this->lang->line('Whois Search'); ?></h5>
