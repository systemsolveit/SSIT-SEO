...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url('who_is/index') ?>"><?php echo $this->lang->line("Whois Search Analysis");?></a></div>
...
<div class="row multi_layout">
  ...
  <span class="sr-only">Loading...</span>
        ...
        <div class="card-footer bg-whitesmoke mt-42">
            ...
            <button class="btn btn-secondary btn-md float-right" onclick="goBack('who_is/who_is')" type="button"><i class="fa fa-remove"></i> <?php echo $this->lang->line('Cancel'); ?></button>
  ...
  <div class="col-12 col-md-7 col-lg-7 colmid">
    ...
    <div id="middle_column_content" style="background: #ffffff!important;">
      ...
      <div class="card">
        <div class="card-header">
          <h4> <i class="fas fa-server"></i> <?php echo $this->lang->line('Whois Search'); ?></h4>
    ...
    $(document).on('click', '#new_search_button', function(event) {
     ...
     var files_list = [];
      $("#file_upload_url").uploadFile({
        url:base_url+"who_is/read_text_csv_file_backlink",
        fileName:"myfile",
        ...
        deleteCallback: function (data, pd) {
            var delete_url="<?php echo site_url('who_is/read_after_delete_csv_txt');?>";
