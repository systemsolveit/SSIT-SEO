    ...
    public function login() //loads home view page after login (this )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                //if(function_exists('fb_app_set'))fb_app_set();
...
{
    // Retrieve the first URI segment
    $controller_name = $this->uri->segment(1);

    // Check if $controller_name is not null before using strtolower
    if ($controller_name !== null) {
        $controller_name = strtolower($controller_name);
    } else {
        // Default to an empty string or handle the null case as needed
        $controller_name = '';  // Or assign a default controller name if applicable
    }
    ...
    {
        echo json_encode(array('status'=>'1','message'=>$this->lang->line('Successfully verified')));
        exit();
    }
